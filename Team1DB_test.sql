...
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'Aiden')
    CREATE DATABASE Aiden COLLATE Chinese_Taiwan_Stroke_CI_AS;
GO
--	使用 Team1DB 資料庫
USE Aiden;
...
CREATE TABLE members (
                         ...
                         avatar VARCHAR(MAX) DEFAULT NULL,
                         phone VARCHAR(50) DEFAULT NULL,--手機號碼
                         signature VARCHAR(500) DEFAULT NULL,--個人簽名
...
IF NOT EXISTS (SELECT TOP 1 * FROM members)
    INSERT INTO members (username, password, nickname, admin,birthday,phone,signature) VALUES
	('admin@admin.com', '$2a$10$.UAoeaAVeH8vhPsxHaw1I.teyo3iBunZllqraM1EmHQJwk1CkwD8u', 'Master', 1,'1997-08-29','09541234567','<h2>很高興為您服務</h2>'),
	('user1@user1.com', '$2a$10$.UAoeaAVeH8vhPsxHaw1I.teyo3iBunZllqraM1EmHQJwk1CkwD8u', '王五', 0,'1994-10-17','09541234567','<h3>我不是李四</h3>'),
	('user2@user2.com', '$2a$10$.UAoeaAVeH8vhPsxHaw1I.teyo3iBunZllqraM1EmHQJwk1CkwD8u', '趙六', 0,'1988-06-02','09541234567','<h3>我不是張三</h3>');
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'Trails')
CREATE TABLE [dbo].[Trails](
    [tid] [int] IDENTITY(1,1) NOT NULL,
    [tname] [nvarchar](255) NULL,
    [tphoto] [varbinary](max) NULL,
    [tphotobase64] [nvarchar](max) NULL,
    [tclass] [nvarchar](100) NULL,
    [tmain] [nvarchar](100) NULL,
    [tlength] [nvarchar](max) NULL,
    [tpave] [nvarchar](100) NULL,
    [tlevel] [nvarchar](100) NULL,
    [ttour] [nvarchar](100) NULL,
    [tseason] [nvarchar](100) NULL,
    [tspecial] [nvarchar](max) NULL,
    [tlat] [decimal](11, 8) NULL,
    [tlng] [decimal](11, 8) NULL,
...
-- Inserting data into the Trails table
    INSERT INTO Trails (tname, tphotobase64)
    VALUES  ('象山', 'https://firebasestorage.googleapis.com/v0/b/fir-web-dffc1.appspot.com/o/images%2F%E8%B1%A1%E5%B1%B1.jpg?alt=media&token=ace4151d-8b2e-42c1-a7de-c2db1459b842'),
('新店獅頭山步道', 'https://firebasestorage.googleapis.com/v0/b/fir-web-dffc1.appspot.com/o/images%2F%E6%96%B0%E5%BA%97%E7%8D%85%E9%A0%AD%E5%B1%B1%E6%AD%A5%E9%81%93.jpg?alt=media&token=433e53f2-868d-4a40-a328-8d2e900aab4a'),
('合歡東峰步道', 'https://firebasestorage.googleapis.com/v0/b/fir-web-dffc1.appspot.com/o/images%2F%E6%9D%B1%E5%B3%B0%E6%AD%A5%E9%81%93.jpg?alt=media&token=3bda662a-f1a7-41e8-9c0d-6daa04323bf9'),
('桶後越嶺步道', 'https://firebasestorage.googleapis.com/v0/b/fir-web-dffc1.appspot.com/o/images%2F%E9%87%91%E7%93%9C%E5%AF%AE%E9%AD%9A%E8%95%A8%E6%AD%A5%E9%81%93.jpg?alt=media&token=1f6c5842-5e25-4d38-a2f1-8ea4dc4e9f36'),
('金瓜寮魚蕨步道', 'https://firebasestorage.googleapis.com/v0/b/fir-web-dffc1.appspot.com/o/images%2F%E9%87%91%E7%93%9C%E5%AF%AE%E9%AD%9A%E8%95%A8%E6%AD%A5%E9%81%93.jpg?alt=media&token=1f6c5842-5e25-4d38-a2f1-8ea4dc4e9f36'),
('拳頭姆自然步道', 'https://firebasestorage.googleapis.com/v0/b/fir-web-dffc1.appspot.com/o/images%2F%E6%8B%B3%E9%A0%AD%E5%A7%86%E8%87%AA%E7%84%B6%E6%AD%A5%E9%81%93.jpg?alt=media&token=24e14441-569b-4fea-b340-32fedd4db373'),
('松羅步道', 'https://firebasestorage.googleapis.com/v0/b/fir-web-dffc1.appspot.com/o/images%2F%E9%87%91%E7%93%9C%E5%AF%AE%E9%AD%9A%E8%95%A8%E6%AD%A5%E9%81%93.jpg?alt=media&token=1f6c5842-5e25-4d38-a2f1-8ea4dc4e9f36')
;



IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'TrailPhotos')
...
---- 檢查 Categories 資料表是否為空，如果為空則插入四筆測試數據
    IF NOT EXISTS (SELECT 1 FROM [Aiden].[dbo].[Categories])
BEGIN
INSERT INTO [Aiden].[dbo].[Categories] ([CategoryName], [Description])
VALUES
    ('新手入門板', '專為那些剛開始踏足登山世界的朋友而設的板塊。在這裡，你可以提出任何有關初次登山的問題，尋求建議、分享經驗，並與其他新手一起成長。我們的社區成員將竭誠回答你的疑問，幫助你順利踏上登山之旅。'),
    ('裝備討論板', '在裝備討論板，你可以盡情分享你所擁有的裝備，包括帳篷、睡袋、登山靴、登山錘等等。你也可以詢問其他會員對於特定裝備的評價、使用心得，或是提出選購裝備時的疑問和建議。'),
    ('攝影與紀錄板', '在攝影與紀錄板，你可以發布你在登山過程中拍攝的精彩照片、影片，並與其他會員分享你的登山經歷和感受。無論是壯麗的山川風景、雄偉的高山景觀還是難忘的登山趣事，都歡迎你在這裡與大家一同分享。'),
    ('交流與結伴板', '在交流與結伴板，你可以發布自己的登山計畫，尋找同路人一同踏上登山旅程，或是組隊挑戰更高的山峰。無論你是想尋找夥伴一同探索陌生的山川，還是想參加其他會員組織的登山活動，這裡都是你找到志同道合的伙伴的地方。');
END
...
---- 檢查 Replies 資料表是否為空，如果為空則插入六筆測試數據
    IF NOT EXISTS (SELECT TOP 1 * FROM  [Aiden].[dbo].[Replies] )
    INSERT INTO [Aiden].[dbo].[Replies] ([ThreadID], [MemberID], [Content], [CreateDate] )
    VALUES
    ( 1, 2, '這是第一筆回覆內容。', '2024-03-13 12:00:00'),
    ( 1, 1, '這是第二筆回覆內容。','2024-03-13 12:15:00'),
    ( 1, 3, '這是第三筆回覆內容。', '2024-03-13 12:30:00'),
    ( 2, 2, '這是第一筆回覆內容。', '2024-03-13 12:00:00'),
    ( 2, 1, '這是第二筆回覆內容。','2024-03-13 12:15:00'),
    ( 2, 3, '這是第三筆回覆內容。', '2024-03-13 12:30:00')
...
IF NOT EXISTS (SELECT TOP 1 * FROM product)
INSERT INTO product (product_name, category, image_url, price, stock, description)
VALUES
    ('登山背包', '登山裝備', 'https://i.pinimg.com/736x/a4/a4/08/a4a408cf4656abb07877e5451ddb732e.jpg', 2000, 50, '高容量、耐用的登山背包，適合長途徒步旅行。'),
    ('攀岩鞋', '登山裝備', 'https://images.unsplash.com/photo-1708290369261-bf7635e46c10?q=80&w=3871&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 1500, 30, '專為攀岩設計的鞋子，提供良好的抓地力和舒適度。'),
    ('登山服', '登山裝備', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjWCFllHJbxQdXllb8G1dqZmrd-GeX5ezrIw&usqp=CAU', 1200, 40, '透氣、防風的登山服，適合各種戶外活動。'),
    ('登山手套', '登山裝備', 'https://images.unsplash.com/photo-1617122951886-6afc68a99e17?q=80&w=3109&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 500, 60, '保暖且具有良好抓握力的登山手套。'),
    ('登山帽', '登山裝備', 'https://images.unsplash.com/photo-1560774358-d727658f457c?q=80&w=3764&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 300, 80, '保護頭部免受陽光和寒風侵襲的登山帽。'),
    ('登山杖', '登山裝備', 'https://images.unsplash.com/photo-1623783593139-f4f36b7bbb2f?q=80&w=3008&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 800, 40, '幫助保持平衡和減輕膝蓋壓力的登山杖。'),
    ('防水登山鞋', '登山裝備', 'https://images.unsplash.com/photo-1529810313688-44ea1c2d81d3?q=80&w=3941&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 1800, 35, '防水且耐磨的登山鞋，適合各種地形。'),
    ('登山頭燈', '登山裝備', 'https://silvasweden.com/cdn/shop/files/mobile-headlamp-guide_300x.jpg?v=1673520791', 600, 50, '夜間登山或露營必備的頭燈，提供充足照明。'),
    ('登山背心', '登山裝備', 'https://images.stylight.net/image/upload/e_trim/t_web_product_330x440max_nobg/q_auto:eco,f_auto/agrz8tmc8sbqloqra4wv.webp', 1000, 45, '輕便且多功能的登山背心，提供額外的保暖和儲物空間。'),
    ('攀岩繩', '登山裝備', 'https://images.unsplash.com/photo-1635360404916-a7919e7de16f?q=80&w=3870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 2200, 20, '高強度的攀岩繩，確保登山安全。');
...
ALTER TABLE [order] ADD receiver_name NVARCHAR(255);
ALTER TABLE [order] ADD receiver_address NVARCHAR(255);
ALTER TABLE [order] ADD receiver_phone NVARCHAR(255);
ALTER TABLE [order] ADD receiver_email NVARCHAR(255);
